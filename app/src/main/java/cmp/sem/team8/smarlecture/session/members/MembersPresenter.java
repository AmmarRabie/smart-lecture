...
public class MembersPresenter implements MembersContract.Actions {
    ...
    private AppDataSource.Listen membersListener;

    private MembersContract.Views mView;
    private AppDataSource mDataSource;

    public MembersPresenter(AppDataSource dataSource, MembersContract.Views view, String sessionId) {
    ...
    public void start() {
        ...
        if (membersListener != null)
            return;
        membersListener = mDataSource.ListenSessionMembers(SESSION_ID, new AppDataSource.Listen<MemberModel>() {
            @Override
    ...
    public void addNote(final String memberId, String noteText) {
        ...
        mDataSource.addNote(SESSION_ID, memberId, noteText, new AppDataSource.Insert<NoteModel>() {
            @Override
...
//                getMember(memberId).getNotes().add(newNote);
    ...
    public void deleteNote(final String memberId, final String noteId) {
        ...
        mDataSource.deleteNote(SESSION_ID, memberId, noteId, new AppDataSource.Delete() {
            @Override
