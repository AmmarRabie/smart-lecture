...
import cmp.sem.team8.smarlecture.common.data.AppDataSource.AttendanceStatus;
...
public class AttendanceMonitorService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        repo.listenAttendanceStatus(sessionId, new AppDataSource.Listen<AppDataSource.AttendanceStatus>() {
            @Override
            public void onDataReceived(AppDataSource.AttendanceStatus currStatus) {
                if (isFirstStatus) {
    ...
    private void startActivity() {
        Intent writeAttendance = new Intent(this, WriteAttendanceActivity.class);
